...
@Component({
    ...
    <div class="auth-page">
      <div class="auth-card">
        <div class="auth-header">
          ...
          <p>Join StellarTickets and start booking today.</p>
        </div>
        ...
        <form (ngSubmit)="onRegister()" #regForm="ngForm">
          ...
          <div class="form-field">
            ...
            <select name="role" [(ngModel)]="userData.role">
          ...
          <button type="submit" class="btn-auth" [disabled]="loading || !regForm.valid">
  ...
  styles: [`
    ...
    .form-field input:focus, .form-field select:focus { outline: none; border-color: #6366f1; box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.1); }
